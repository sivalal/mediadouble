angular.module("slidenav",[])
  ...
  .directive("slidenav", ['stSlideNavCssClasses',function(stSlideNavCssClasses){
      return {
          ...
          scope: {},
          transclude: true,
          template: '<div id="slidenavcontainer" class="'+ stSlideNavCssClasses.site + '" ng-class="{\'' + stSlideNavCssClasses.menuOpen + '\': slidenav.isOpen()}" ng-transclude></div>',
          replace: true,
  ...
  .directive("slidenavMenu", ['stSlideNavCssClasses', function(stSlideNavCssClasses){
      return {
          ...
          transclude: true,
          scope: {},  
          template: '<nav id="navig" class="' + stSlideNavCssClasses.nav + '" ng-transclude ></nav>',
          replace: true,
  ...
  .directive("slidenavContent", ['slidenav', 'stSlideNavCssClasses', function(slidenav, stSlideNavCssClasses){
      return {
          ...
          transclude: true,
          scope: {},
          template: '<div><div id="contentOver" class="' + stSlideNavCssClasses.contentOverlay + '" ng-click="closeNav()"></div><div class="' + stSlideNavCssClasses.content + '" ng-transclude></div></div>',
          replace: true,
